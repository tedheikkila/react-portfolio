...
export default function Resume() {
  return (
    <div>
      ...
      <h2 className="resume">
        <a className="resume-link" href="https://drive.google.com/file/d/1YA0iQnUAhv61c9eDHVbo_K7B9ZPgxyfm/view?usp=sharing" target="_blank" rel="noreferrer">pdf Resume</a>
      </h2>
    </div>
  );
}
